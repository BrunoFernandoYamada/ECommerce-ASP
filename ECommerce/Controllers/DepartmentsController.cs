...
namespace ECommerce.Controllers
{
    public class DepartmentsController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (System.Exception ex)
                {
                    if (ex.InnerException != null && ex.InnerException.InnerException
                         != null && ex.InnerException.InnerException.Message.Contains("_Index"))
                    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            {
                if(ex.InnerException != null && ex.InnerException.InnerException
                     != null && ex.InnerException.InnerException.Message.Contains("REFERENCE"))
                {
                    ModelState.AddModelError(string.Empty, "Não é possível remover o departamento, pois há cidades relacionadas a ele, primeiro remova a cidade e volte a tentar!!");
                }
                else
                {
                    ModelState.AddModelError(string.Empty, ex.Message);
